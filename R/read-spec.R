...
#' read single spectral data from cell path
#'
#' This function cread single spectral data from cell path.
#'
#' @param cell_path The file path
#' @param xout A numeric vector with two values representing the lower and upper bound cutoff values.
#'
#' @return The subset of spectral data within the specified cutoff range.
#'
#' @import stats
